...
public interface BoughtRepository extends CrudRepository<BoughtItem, Long> {
    ...
    void saveItem(@Param("userId")Long userId, @Param("itemId")Long itemId, @Param("statusValue")String statusValue, @Param("cardNumber")String cardNumber, @Param("address")String address);
